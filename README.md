 # Task_4  Goodcabs Transportation Dashboard

 The Dashboard contains all necessary KPI's with slicers to show results monthly.
 
 The Dataset has been decsribed below:-
